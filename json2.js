...
data.forEach((u)=>{
    ...
    temp += "<td>" + u.Info +"</td>";
    temp += "<td>" + u.ID +"</td>";
    temp += "<td>" + u.persona +"</td>";
    temp += "<td>" + u.Crush +"</td>";
    temp += "<td>" + u.BreastSize +"</td>";
    temp += "<td>" + u.Strength +"</td>";
    temp += "<td>" + u.Hairstyle +"</td>";
    temp += "<td>" + u.Eyes +"</td>";
    temp += "<td>" + u.EyeType +"</td>";
    temp += "<td>" + u.Stockings +"</td>";
    temp += "<td>" + u.ScheduleTime +"</td>";
    temp += "<td>" + u.ScheduleDestination +"</td>";
    temp += "<td>" + u.ScheduleAction +"</td>";
    temp += "<td>" + u.info +"</td>"
    "</tr>";
